...
ENVAMELEON_NOOP_RUBY_REQUIREMENT = Gem::Requirement.new(">= #{ENVAMELEON_RUBY_API_VERSIONS.first}")
ENVAMELEON_NATIVE_RUBY_REQUIREMENT = Gem::Requirement.new(
  ">= #{ENVAMELEON_RUBY_API_VERSIONS.first}",
  "< #{ENVAMELEON_NEXT_RUBY_API_VERSION}.0.dev"
)
ENVAMELEON_SOURCE_RUBY_REQUIREMENT = Gem::Requirement.new(">= #{ENVAMELEON_NEXT_RUBY_API_VERSION}.0.dev")
